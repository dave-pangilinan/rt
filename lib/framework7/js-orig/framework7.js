            ...
            if (openIn === 'picker') {
                ...
                navbarHTML = app._compiledTemplates.smartSelectNavbar({
                    ...
                    leftTemplate: openIn === 'popup' ? 
                        (app.params.smartSelectPopupCloseTemplate || (material ? '<div class="left"><a href="#" class="link close-popup icon-only"><i class="material-icons">arrow_back</i></a></div>' : '<div class="left"><a href="#" class="link close-popup"><i class="material-icons">arrow_back</i><span>{{closeText}}</span></a></div>')).replace(/{{closeText}}/g, closeText) :
                        (app.params.smartSelectBackTemplate || (material ? '<div class="left"><a href="#" class="back link icon-only"><i class="material-icons">arrow_back</i></a></div>' : '<div class="left sliding"><a href="#" class="back link"><i class="material-icons">arrow_back</i><span>{{backText}}</span></a></div>')).replace(/{{backText}}/g, backText)
                });
                ...
                a.navbarTemplate = t7.compile(a.params.navbarTemplate ||
                    '<div class="navbar {{#if navbarTheme}}theme-{{navbarTheme}}{{/if}}">' +
                        '<div class="navbar-inner">' +
                            '<div class="left sliding">' +
                                '{{#if material}}' +
                                '<a href="#" class="link {{#if inPopup}}close-popup{{else}}back{{/if}} icon-only"><i class="material-icons">arrow_back</i></a>' +
                                '{{else}}' +
